...
def main():
    ...
    glutCreateMenu(menu)
    glutAddMenuEntry("Bunny", MENU_BUNNY)
    glutAddMenuEntry("Subdivided Bunny", MENU_SUBDIVIDED_BUNNY)
    glutAddMenuEntry("Subdivided Bunny 2", MENU_SUBDIVIDED_BUNNY2)
    glutAddMenuEntry("----------------------------", MENU_DIVIDER)
    glutAddMenuEntry("Tetrahedron", MENU_TETRAHEDRON)
    glutAddMenuEntry("Subdivided Tetrahedron", MENU_SUBDIVIDED_TETRAHEDRON)
    glutAddMenuEntry("Subdivided Tetrahedron 2", MENU_SUBDIVIDED_TETRAHEDRON2)
    glutAddMenuEntry("Subdivided Tetrahedron 3", MENU_SUBDIVIDED_TETRAHEDRON3)
    glutAddMenuEntry("Subdivided Tetrahedron 4", MENU_SUBDIVIDED_TETRAHEDRON4)
    glutAddMenuEntry("----------------------------", MENU_DIVIDER)
    glutAddMenuEntry("Triangulated Cube", MENU_TRI_CUBE)
    glutAddMenuEntry("Subdivided Triangulated Cube", MENU_SUBDIVIDED_TRI_CUBE)
    glutAddMenuEntry("Subdivided Triangulated Cube 2", MENU_SUBDIVIDED_TRI_CUBE2)
    glutAddMenuEntry("Subdivided Triangulated Cube 3", MENU_SUBDIVIDED_TRI_CUBE3)
    glutAddMenuEntry("----------------------------", MENU_DIVIDER)
    glutAddMenuEntry("Shading on/off", MENU_SHADE)
    glutAddMenuEntry("Cull backfaces on/off", MENU_CULL_BACKFACES)
    glutAddMenuEntry("Annotatation on/off", MENU_ANNOTATE)
